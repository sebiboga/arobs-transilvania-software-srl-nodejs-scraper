...
1. **Start with brand** - We know the brand (e.g., "AROBS")
...
> **Important**: Scraper does NOT delete jobs from other sources (ANOFM, etc). It only upserts AROBS jobs. Existing jobs are preserved.
