...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "AROBS") |
| group        | string   | Parent company group (e.g. "AROBS Group") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/arobs-transilvania-software-srl-nodejs-scraper/master/.github/workflows/scrape.yml`)
